...
<div class="card mx-auto">
    <div class="card-body">
        <form action="gerar-declaracao.php" method="post" target="_blank" class="row d-flex justify-content-center needs-validation"
            ...
            <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="nome_<?= $key ?>"
                                       placeholder="Lucas Felipe" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control documento" name="documento_<?= $key ?>"
                                       placeholder="454.999.888-78" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cep" name="cep_<?= $key ?>"
                                       data-tipo="<?= $key ?>" placeholder="17032-520" required>
                        ...
                        <div class="col-md-5">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="cidade_<?= $key ?>"
                                       placeholder="Bauru" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <select name="uf_<?= $key ?>" name="uf_<?= $key ?>" class="form-select estados"
                                        required>
                                    <option value="">--</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="endereco_<?= $key ?>" minlength="9"
                                       required placeholder="Rua. Teste 123">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control datepicker" name="dt_envio" required
                ...
                <div class="row">
                    ...
                    <div class="conteudo-container">
                        <div class="conteudo row" data-index="1">
                            <div class="col-md-7">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="conteudo[1][name]" id="conteudo_1"
                            ...
                            <div class="col-5 col-md-2">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control quantidade"
                                           name="conteudo[1][quantidade]" id="quantidade_1"
                            ...
                            <div class="col-5 col-md-2">
                                <div class="form-floating">
                                    <input type="number" class="form-control" name="conteudo[1][valor]" id="valor_1"
